...
- Create Angular project with ng: `ng new vinay-angular-dotnetcore-ai.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`vinay-angular-dotnetcore-ai.client.esproj`).
